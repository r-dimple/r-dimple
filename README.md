...
I'm a final-year **B.Sc. Information Technology** student (CGPA 8.8/10) who ships production-grade AI products — not just notebooks or side projects.
...
![LangSmith](https://img.shields.io/badge/LangSmith-f59e0b?style=flat-square)
![OpenAI](https://img.shields.io/badge/OpenAI%20API-412991?style=flat-square&logo=openai&logoColor=white)
![Groq](https://img.shields.io/badge/Groq%20AI-f97316?style=flat-square)
![CrewAI](https://img.shields.io/badge/CrewAI-06b6d4?style=flat-square)
![AutoGen](https://img.shields.io/badge/AutoGen-0ea5e9?style=flat-square)
![RAG Pipelines](https://img.shields.io/badge/RAG%20Pipelines-8b5cf6?style=flat-square)
...
![Ubuntu](https://img.shields.io/badge/Ubuntu%20VPS-E95420?style=flat-square&logo=ubuntu&logoColor=white)
...
### 🤖 [SparrowAI](https://sparrowai.leftnote.com) — AI Chatbot SaaS Platform
> `Django` · `PostgreSQL` · `OpenAI API` · `LangChain` · `Docker` · `JavaScript`
...
### 📄 [DocMind](https://docmind.leftnote.com) — Document Intelligence Platform
> `LangChain` · `Pinecone` · `FastAPI` · `Groq AI` · `Flask` · `Tailwind CSS` · `Docker` · `Caprover`
...
### 🛒 [Cartify](https://cartify.leftnote.com) — E-Commerce App
> `Laravel` · `PHP` · `MySQL` · `Bootstrap` · `Docker`

Full-featured e-commerce app with product listings, cart, authentication, and order flow using Laravel MVC. Containerized with Docker and deployed on Ubuntu VPS.

---

### 🖼️ [Penz](https://penz.leftnote.com) — AI Image Converter
> `Python` · `OpenCV` · `Flask` · `OpenAI API` · `Docker`

Image processing web app supporting grayscale, PNG, JPG, and WebP conversion, with an integrated AI chatbot assistant for user guidance.
...
|--------|-------------|------|-------|
| B.Sc. Information Technology | — | 2023 – 2026 (Expected) | CGPA **8.8 / 10.0** |
| Senior Secondary (Maths + CS) | — | 2021 – 2023 | **84.2%** |
| Secondary Education | — | 2021 | **84.4%** |

---

## 🤝 Let's Connect

I'm actively looking for **AI/ML Engineer** and **Backend + AI** roles — remote or on-site. If you're building something with LLMs, RAG, or agentic systems, I'd love to talk.
